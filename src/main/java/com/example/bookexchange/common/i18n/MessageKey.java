...
public enum MessageKey {
    ...
    ADMIN_DEMO_RESET_COMPLETED("admin.demo.reset.completed"),
    ...
    SYSTEM_DEMO_ACCESS_REQUIRED("system.demo.access.required"),
    SYSTEM_DEMO_RESET_DISABLED("system.demo.reset.disabled"),
    SYSTEM_DEMO_RESET_IN_PROGRESS("system.demo.reset.in.progress"),
    SYSTEM_DEMO_RESET_SEED_NOT_CONFIGURED("system.demo.reset.seed.not.configured"),
